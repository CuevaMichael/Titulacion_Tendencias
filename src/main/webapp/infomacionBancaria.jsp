        ...
        <div class="container mt-3 ">
            <div class="row ">
                <div class="col-md-20 offset-md-0">
                    ...
                    <div class="mb-3">
                        <p style="font-size: larger; color: white;" ><b>INFORMACIÓN BANCARIA</b></p>
                ...
                <form action="MostrarDatosBanco" method="post">
                    <div class="container-fluid">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <label for="idUpdate" class="form-label">ID para editar la Institucion Financiera</label>
                            ...
                            <div class="col-md-6">
                                <label for="datos" class="form-label">Institución Financiera</label>
            ...
            <div class="col-sm-18">
                <table class="table table-hover">
                    ...
                    <script>
                        function redirectToInformacionBancariaInsert(id) {
