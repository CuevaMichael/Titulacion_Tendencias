...
<html>
    <head>
        ...
        <title>Registro de Inclusión</title>
    </head>
                ...
                <div class="col-lg-6 mx-auto">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-5">
                            ...
                            <h2 class="text-center mb-5">Agregar/Modificar registro de Inclusión Laboral</h2>
                            ...
                            <form action="ServletInsertInclucionLaboral" method="post">
                                ...
                                <div class="form-group">
                                    <label for="idInclucionLaboral" class="form-label">ID Inclusión Laboral</label>
                                    <input name="idInclucionLaboral" type="text" class="form-control" id="idInclucionLaboral">
                                </div>
