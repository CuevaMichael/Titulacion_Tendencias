...
<html>
    <head>
        ...
        <title>Enfermedad / Discapacidad</title>
    </head>
        ...
        <div class="container mt-3 ">
            <div class="row ">
                <div class="col-md-20 offset-md-0">
                    ...
                    <div class="mb-3">
                        <p style="font-size: larger; color: white;" ><b>DISCAPACIDAD O ENFERMEDAD</b></p>
                ...
                <form action="MostrarDatosEnfermedad" method="post">
                    <div class="container-fluid">
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <label for="deleteId" class="form-label">ID para eliminar su Discapacidad/Enfermedad</label>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <label for="idUpdate" class="form-label">ID para editar su Tipo de Enfermedad</label>
                            ...
                            <div class="col-md-6">
                                <label for="datos" class="form-label">Tipo de Enfermedad </label>
                ...
                <table class="table table-hover">
                    <thead>
                        <tr>
                            ...
                            <th>ID</th>
                            <th>SITUACIÓN</th>
                            <th>NÚMERO DEL CARNET CONADIS</th>
                            <th>CERTIFICADO DE ENFERMEDAD CATASTROFICA</th>     
                    ...
                    <tr onclick="redirectToEnfermedadInsert('<%= capas.getIdDiscapacidadOenfermedad() %>')">
                        ...
                        <td><%= capas.getNumeroCarnetConadis()%></td>
                    ...
                    <script>
                        function redirectToEnfermedadInsert(id) {
