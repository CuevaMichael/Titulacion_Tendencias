 ...
 * @author Michael
 */
@WebServlet(name = "MostrarDatosHijo", urlPatterns = {"/MostrarDatosHijo"})
public class MostrarDatosHijo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet MostrarDatosHijo</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet MostrarDatosHijo at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
