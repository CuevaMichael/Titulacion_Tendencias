 ...
 * @author Michael
 */
@WebServlet(name = "MostrarDatosPermisos", urlPatterns = {"/MostrarDatosPermisos"})
public class MostrarDatosPermisos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet MostrarDatosPermisos</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet MostrarDatosPermisos at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    try {
                ...
                if ("Otros".equals(datos)) {
                    datos = request.getParameter("otrosMotivo");
                }
