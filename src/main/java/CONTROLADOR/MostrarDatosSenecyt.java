 ...
 * @author david
 */
@WebServlet(name = "MostrarDatosSenecyt", urlPatterns = {"/MostrarDatosSenecyt"})
public class MostrarDatosSenecyt extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet MostrarDatosSenecyt</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet MostrarDatosSenecyt at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
