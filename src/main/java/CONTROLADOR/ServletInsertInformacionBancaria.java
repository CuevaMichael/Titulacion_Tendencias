...
public class ServletInsertInformacionBancaria extends HttpServlet {
    ...
    //estas variables se usaran para recibir los datos 
        ...
        String idInformacionBancariaParam = request.getParameter("idInformacionBancaria");
        if (idInformacionBancariaParam != null && !idInformacionBancariaParam.isEmpty()) {
            idInformacionBancaria = Integer.parseInt(idInformacionBancariaParam);
        } else {
