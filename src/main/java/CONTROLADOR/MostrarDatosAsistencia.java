 ...
 * @author Michael
 */
@WebServlet(name = "MostrarDatosAsistencia", urlPatterns = {"/MostrarDatosAsistencia"})
public class MostrarDatosAsistencia extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet MostrarDatosAsistencia</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet MostrarDatosAsistencia at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
