 ...
 * @author Michael
 */
@WebServlet(name = "MostrarDatosContactoEmergencia", urlPatterns = {"/MostrarDatosContactoEmergencia"})
public class MostrarDatosContactoEmergencia extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet MostrarDatosContactoEmergencia</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet MostrarDatosContactoEmergencia at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
